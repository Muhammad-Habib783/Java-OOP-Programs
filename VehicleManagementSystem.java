class Vehicle// parent class 
{
 ...
 void displayInfo()// function to display vehicle information
 {
     ...
     System.out.println("DailyRentalRate: "+dailyRentalRate);
 }
}
...
public class VehicleManagementSystem// main class
{
 public static void main(String[] args) 
 {
     ...
     LuxuryCar luxuryCar=new LuxuryCar("Honda","abc",2023,120.0,true,true,true);// true for boolean
     int days=5; 
